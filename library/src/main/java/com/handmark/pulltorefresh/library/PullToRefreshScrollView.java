...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
	...
	protected ScrollView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			...
			Log.i("ly","scrollview 1");
		} else {
			scrollView = new ScrollView(context, attrs);
			Log.i("ly","scrollview 2");
		}
	...
	private boolean isInternalScrollViewDisabled =false;
	public void setDisableInternalScrollView(boolean flag){
		isInternalScrollViewDisabled =flag;
	}
	@TargetApi(9)
	public final class InternalScrollViewSDK9 extends ScrollView {

		private static final String TAG = "InternalScrollViewSDK9";
		...
		public boolean onInterceptTouchEvent(MotionEvent event) {
			...
			if(isInternalScrollViewDisabled){
				return false;
			}else{
