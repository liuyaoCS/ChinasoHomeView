...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		...
		Log.i("height","#isReadyForPullEnd# web ContentHeight->"+exactContentHeight
				+" scrollRange->"+(exactContentHeight - mRefreshableView.getHeight())
				+" mRefreshableView.getScrollY()->"+mRefreshableView.getScrollY()
				+" isReadyForPullEnd->"+(mRefreshableView.getScrollY() >= (exactContentHeight - mRefreshableView.getHeight()))
		);

		return mRefreshableView.getScrollY()+2 >= (exactContentHeight - mRefreshableView.getHeight());
	}
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			Log.i("height","#getScrollRange# web ContentHeight->"+mRefreshableView.getContentHeight() * mRefreshableView.getScale()
					+" getHeight->"+getHeight()
					+" getScrollRange->"+(Math.max(0, FloatMath.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
